...
use tpmctl_core::{
    CoreError, DeriveFormat, HashAlgorithm, SignInput,
...
pub fn run(_runtime: tpmctl_core::RuntimeOptions, args: &DeriveArgs) -> Result<(), CliError> {
    ...
    let seed_bytes = unseal_request.execute()?;
